  ...
  return (
    <div className="min-h-screen flex bg-white font-outfit relative">
      ...
      <button
        ...
        className="absolute top-safe right-6 z-50 flex items-center gap-2 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-slate-200 shadow-sm hover:shadow-md hover:bg-white text-slate-700 font-bold text-sm transition-all group"
      >
        ...
        <div className="max-w-md w-full relative z-10 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              {/* Apple login — desactivado temporalmente. Requiere cuenta Apple Developer ($99/año). Código preservado en authService.loginWithApple */}
              {/* <button
              ...
              {/* Facebook login — desactivado temporalmente. Código preservado en authService.loginWithFacebook */}
              {/* <button
