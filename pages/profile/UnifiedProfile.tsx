...
import { LayoutDashboard, User as UserIcon, Lock, TrendingUp, Gift } from 'lucide-react';
...
export const UnifiedProfile: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'details' | 'stats' | 'security' | 'referrals'>('details');
