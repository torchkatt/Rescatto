...
export const SecuritySettings: React.FC = () => {
    ...
    const handleChangePassword = async (e: React.FormEvent) => {
        ...
        if (!currentPassword) {
            showToast('error', 'Debes ingresar tu contraseña actual');
            return;
        }
        ...
        try {
            ...
            if (error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
                ...
                showToast('error', 'Por seguridad, debes volver a iniciar sesión para cambiar tu contraseña.');
                logout();
            } else {
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div className="max-w-md">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                    <h3 className="text-sm font-bold text-gray-900 mb-2">Sesiones Activas</h3>
                    <p className="text-sm text-gray-500 mb-4">
                        Si crees que tu cuenta ha sido comprometida, puedes cerrar sesión en todos los dispositivos.
                    </p>
                    <button
                        onClick={logout}
