...
export const VenueSchema = z.object({
  ...
  latitude: z.number().optional().nullable().transform(v => v ?? 0),
  longitude: z.number().optional().nullable().transform(v => v ?? 0),
  closingTime: z.string().optional().nullable().transform(v => v ?? '22:00'),
